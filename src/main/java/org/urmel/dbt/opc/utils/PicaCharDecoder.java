...
public class PicaCharDecoder {
	...
	private static final Map<String, Map<Integer, String>> picaChars = new HashMap<String, Map<Integer, String>>() {
		{
	...
	public static String decode(final String plain, final int encoding) {
		...
		for (Map.Entry<String, Map<Integer, String>> picaChar : picaChars
				.entrySet()) {
