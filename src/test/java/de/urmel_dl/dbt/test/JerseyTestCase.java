...
public class JerseyTestCase extends JerseyTest {
     ...
     */
    public JerseyTestCase(TestContainerFactory testContainerFactory) {
     ...
     */
    public JerseyTestCase(AppDescriptor ad) throws TestContainerException {
        super(ad);
    }
     ...
     * @throws TestContainerException
     */
    public JerseyTestCase(String... packages) throws TestContainerException {
        super(packages);
    }
